...
#         GOVERN_APIKEY = pick("govern_API_key",alt_env="GOVERN_API_KEY")
        ...
        BP_M_ID, BV_M_ID = "bp.external_models", "bv.azureml_model"

        # Model version
        BP_VER_ID, BV_VER_ID = "bp.external_model_version", "bv.azureml_model_version"

        # Dataset
        BP_DS_ID, BV_DS_ID = "bp.govern_dataset", "bv.iso-dataset"
        ...
        F_EXT_D, F_VER_D, F_DESC_D, F_TAGS_D = "external_id", "version", "description", "tags_json"
        F_CRTON_D, F_CRTBY_D, F_URL_D = "created_on", "created_by", "url_azureml"
        F_LASTMOD_D, F_MODBY_D, F_PATH_D = "most_recent_update", "modified_by", "path"


        # relationships
        F_PROJ_MODELS     = "govern_models"               # project → [models]
        ...
        F_DS_LINK_MODEL   = "iso_model_version"           # dataset → version (single in your BV)
